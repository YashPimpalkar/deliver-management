...
useEffect(() => {
  ...
  // ✅ New: Toggle availability API call
const handleToggleAvailability = async () => {
  const userId = getUserId(); // make sure this function returns the logged-in user's ID
  if (!userId) {
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className={`flex items-center space-x-2 px-4 py-2 rounded-lg font-semibold text-white transition-colors ${
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center space-x-2 px-4 py-2 rounded-lg font-semibold text-white bg-blue-500 hover:bg-blue-600 disabled:bg-blue-300 transition-colors"
            >
              <MapPin size={18} />
